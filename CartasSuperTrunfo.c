...
int main() {
    ...
    printf("\n=========================================================="
       ...
       printf("\n=========================================================="
              ...
              "\nPIB: Carta %d venceu"
              "\nPIB per capta: Carta %d venceu"
              "\nDensidade Populacional: Carta %d venceu"
              "\nQuantidade de lugares túristicos: Carta %d venceu"
              "\nSuper Poder: Carta %d venceu"
              "\n==========================================================",
              2 - (area1 > area2), 2 - (populacao1 > populacao2), 2 - (pib1 > pib2), 2 - (pibcap1 > pibcap2), 2 - (densidade1 < densidade2), 2 - (turistico1 > turistico2), 2 - (superpoder1 > superpoder2));
